const Library = process.env.DB_TYPE === 'mysql' ? require('../models/Library') : require('../models/LibraryMongo');
...
const createBook = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: `Error creating book: ${error.message}` });  // Más detalles en el mensaje de error
    }
};
